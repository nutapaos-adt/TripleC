...
## 3. ทำไม `status` ในข้อมูลตัวอย่างถึงมี 4 ค่า

ข้อมูลตัวอย่าง 4 รายการใน `referrals` ถูกเลือกให้ครอบคลุมสถานะครบทุกค่าโดยตั้งใจ เพื่อให้ผู้ตรวจเห็น
วงจรชีวิตทั้งหมดของเคสในชุดข้อมูลตัวอย่างเดียว:
