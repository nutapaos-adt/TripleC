...
เยี่ยมบ้าน/โทรติดตาม → บันทึกผล → AI วิเคราะห์ความเสี่ยง (ร่าง) →
...
flowchart TB
    ...
    subgraph ติดตามและบันทึกผล
        ...
        FGR[การบันทึกผลการติดตาม<br/>Outcome Recording]
    end
...
- **เครื่องมือร่างข้อมูลด้วย AI (AI Draft Engine)** — สร้าง**ร่าง**เนื้อหาที่ช่วยให้มนุษย์ทำงานเร็วขึ้น
  โดยอ่านข้อมูลดิบของเคสตอนรับเข้าแล้วสร้างร่างสรุปข้อมูลเคส —
  ผลลัพธ์เป็น **draft ที่แก้ไขได้และยังไม่ผูกกับการตัดสินใจใด ๆ**
...
- **การบันทึกผลการติดตาม (Outcome Recording)** — เป็นจุดที่บันทึกผลลัพธ์จริงจากการเยี่ยมบ้าน/โทรติดตามในแต่ละครั้ง
...
flowchart TD
    ...
    E --> F["ทีมเยี่ยมบ้าน/ติดตาม<br/>ออกเยี่ยมบ้าน หรือ โทรติดตาม"]
...
**ขั้นที่ 5 — เยี่ยมบ้าน/โทรติดตาม**
เมื่อถึงกำหนดการ ทีมเยี่ยมบ้านออกเยี่ยมบ้านหรือโทรติดตามผู้ป่วยตามกำหนดการที่สร้างไว้ — ขั้นนี้เป็นการ
ปฏิบัติงานภาคสนามล้วน ๆ ยังไม่มีการสร้าง/อ่าน/อัปเดตข้อมูลใดในระบบ (ข้อมูลจะถูกบันทึกในขั้นถัดไปหลังเยี่ยม/
โทรเสร็จสิ้น) และยังไม่มี AI เข้ามาเกี่ยวข้องในขั้นนี้
